...
def preprocess(bibfile_path, outfile):
    ...
    with open(outfile, 'w') as out:
        out.write('@comment{This file was generated by preprocess_jabref_bibfile.py}\n\n')
...
_remove_unrelated_fields.fields_to_keep = {
    ...
    'incollection': [
        "author", "editor", "title", "booktitle", "year", "publisher",
        "address", "pages"
    ],
    'inproceedings': [
    ...
    'inbook': [
        "author", "title", "booktitle", "year", "publisher", "address",
        "pages"
    ],
}
